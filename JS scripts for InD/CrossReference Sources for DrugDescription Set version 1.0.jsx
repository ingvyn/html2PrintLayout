...
function Main() {
    ...
    var mySetDest = doc.hyperlinkTextDestinations; //массив текстовых привязок документа
    ...
    var xmlCrossRefArr = xmlRoot.evaluateXPathExpression("descendant::OPIS_DV/descendant::crossRef[@href] | descendant::Opis_Synonym_ZAK/descendant::crossRef[@href]");//массив всех xml-элементов crossRef  в главе Описания лекарств    
