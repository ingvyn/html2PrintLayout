...
function Main() {
    ...
    var xmlCrossRefArr = xmlRoot.evaluateXPathExpression("descendant::Puk_Preparat/descendant::crossRef[@href] | descendant::PUK_DVName/descendant::crossRef[@href]");//массив всех xml-элементов crossRef  в разделе "Предметный указатель"
