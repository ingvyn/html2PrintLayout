...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="body">
        ...
        <Chapter xmlns:aid="http://ns.adobe.com/AdobeInDesign/4.0/" xmlns:aid5="http://ns.adobe.com/AdobeInDesign/5.0/">
            ...
            <!-- Ставится принудительно закрывающийся тег </OPIS> перед закрывающимся тегом </Chapter> для зхакрытия последнего описания-->
            <xsl:text disable-output-escaping="yes"><![CDATA[</OPIS>]]></xsl:text></Chapter>
    </xsl:template>
